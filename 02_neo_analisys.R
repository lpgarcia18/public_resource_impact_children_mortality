...
fit_public <- svyglm(MEAN_RATE_NEO ~ PUBLIC_EXP_PER_CAP_LAGGED2  +
...
fit_health <- svyglm(MEAN_RATE_NEO ~ HEALTH_EXP_LAGGED2  +
	   	          	FERTILITY_RATE_LAGGED +          
				PLUS_65_YEARS_LAGGED +          
				GDP_PER_CAP_LAGGED1 +
				OOP_PER_CAP_LAGGED3 +
...
fit_other <- svyglm(MEAN_RATE_NEO ~ OTHER_EXP_LAGGED2  +
	   	          	FERTILITY_RATE_LAGGED +          
				PLUS_65_YEARS_LAGGED +          
				GDP_PER_CAP_LAGGED1 +
				OOP_PER_CAP_LAGGED3 +
