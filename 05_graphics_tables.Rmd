...
impact_table$`5%` <- round(impact_table$`5%`, 3) 
impact_table$`95%` <- round(impact_table$`95%`, 3) 
impact_table$CI_90 <-  paste0("(",impact_table$`5%`,", ", impact_table$`95%`,")")
impact_table$"Impact\n(CI99%)\n(CI95%)\n(CI90%)" <- paste0(impact_table$Est.,impact_table$CI_99, impact_table$CI_95,impact_table$CI_90, sep="\n")
...
impact_sensib_imputation_table$`5%` <- round(impact_sensib_imputation_table$`5%`, 3) 
impact_sensib_imputation_table$`95%` <- round(impact_sensib_imputation_table$`95%`, 3) 
impact_sensib_imputation_table$CI_90 <-  paste0("(",impact_sensib_imputation_table$`5%`,", ", impact_sensib_imputation_table$`95%`,")")
impact_sensib_imputation_table$"Impact\n(CI99%)\n(CI95%)\n(CI90%)" <- paste0(impact_sensib_imputation_table$Est.,impact_sensib_imputation_table$CI_99, impact_sensib_imputation_table$CI_95,impact_sensib_imputation_table$CI_90, sep="\n")
...
impact_sensib_gps_model_table$`5%` <- round(impact_sensib_gps_model_table$`5%`, 3) 
impact_sensib_gps_model_table$`95%` <- round(impact_sensib_gps_model_table$`95%`, 3) 
impact_sensib_gps_model_table$CI_90 <-  paste0("(",impact_sensib_gps_model_table$`5%`,", ", impact_sensib_gps_model_table$`95%`,")")
impact_sensib_gps_model_table$"Impact\n(CI99%)\n(CI95%)\n(CI90%)" <- paste0(impact_sensib_gps_model_table$Est.,impact_sensib_gps_model_table$CI_99, impact_sensib_gps_model_table$CI_95,impact_sensib_gps_model_table$CI_90, sep="\n")
