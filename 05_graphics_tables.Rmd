...
impact <- read_csv("bases/impact_sensib_imputation.csv")
impact <- read_csv("bases/impact_sensib_gps_model.csv")
...
impact_table$CI <-  paste0("(",impact_table$`2.5%`,", ", impact_table$`97.5%`,")")
impact_table$"Impact\n(CI95%)" <- paste0(impact_table$Est., impact_table$CI, sep="\n")
impact_table$Est. <- NULL
impact_table$`2.5%` <- NULL
impact_table$`97.5%` <- NULL
impact_table$CI <- NULL
names(impact_table) <- c("Treatment", "Mortality rate", "Impact\n(CI95%)")
impact_table <- impact_table %>% dplyr::select("Treatment", "Mortality rate","Impact\n(CI95%)")
...
impact_sensib_imputation_table$CI <-  paste0("(",impact_sensib_imputation_table$`2.5%`,", ", impact_sensib_imputation_table$`97.5%`,")")
impact_sensib_imputation_table$"Impact\n(CI95%)" <- paste0(impact_sensib_imputation_table$Est., impact_sensib_imputation_table$CI, sep="\n")
impact_sensib_imputation_table$Est. <- NULL
impact_sensib_imputation_table$`2.5%` <- NULL
impact_sensib_imputation_table$`97.5%` <- NULL
impact_sensib_imputation_table$CI <- NULL
names(impact_sensib_imputation_table) <- c("Treatment", "Mortality rate", "Impact\n(CI95%)")
impact_sensib_imputation_table <- impact_sensib_imputation_table %>% dplyr::select("Treatment", "Mortality rate","Impact\n(CI95%)")
...
impact_sensib_gps_model_table$CI <-  paste0("(",impact_sensib_gps_model_table$`2.5%`,", ", impact_sensib_gps_model_table$`97.5%`,")")
impact_sensib_gps_model_table$"Impact\n(CI95%)" <- paste0(impact_sensib_gps_model_table$Est., impact_sensib_gps_model_table$CI, sep="\n")
impact_sensib_gps_model_table$Est. <- NULL
impact_sensib_gps_model_table$`2.5%` <- NULL
impact_sensib_gps_model_table$`97.5%` <- NULL
impact_sensib_gps_model_table$CI <- NULL
names(impact_sensib_gps_model_table) <- c("Treatment", "Mortality rate", "Impact\n(CI95%)")
impact_sensib_gps_model_table <- impact_sensib_gps_model_table %>% dplyr::select("Treatment", "Mortality rate","Impact\n(CI95%)")
